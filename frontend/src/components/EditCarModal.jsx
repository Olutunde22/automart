...
import { years, make, condition, body, errorHandler, successHandler } from '../utilities/index.js';
...
const editCarSchema = Yup.object().shape({
	...
	price: Yup.number('Price must be a number').required('Please include the price of the car'),
});
...
const EditCarModal = ({ modal, onModalClose, carPost, setCarPost }) => {
	...
	const handleSubmit = async (
      ...
      setpostDetails(savedCar.data)
      setDescription(savedCar.data.description)
								...
								>
									{({ isSubmitting, errors, touched }) => (
										<Form>
											...
											<div className="flex flex-wrap -mx-3 mb-2 md:mt-10">
												...
												<div className="w-full md:w-1/2 lg:w-1/3  px-3 mb-6 md:mb-0">
													...
													/>
													<ErrorMessage className="text-red-500" component="div" name="color" />
												</div>
												...
												<div className="w-full md:w-1/2 lg:w-1/3  px-3 mb-6 md:mb-0">
													...
													<Field
														...
														placeholder="Price"
													/>
													<ErrorMessage className="text-red-500" component="div" name="price" />
												</div>
											</div>
